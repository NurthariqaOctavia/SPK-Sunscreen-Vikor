...
while($alt = mysqli_fetch_array($q2)){
    ...
    $alternatifs[$alt['id_alternatif_v']]['spf'] = $alt['spf'];
    $alternatifs[$alt['id_alternatif_v']]['harga'] = $alt['harga'];
    $alternatifs[$alt['id_alternatif_v']]['berat'] = $alt['berat'];
} 
...
<div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-info"><i class="fa fa-table"></i> Tabel Alternatif</h6>
    </div>
                ...
                <tbody>
                    ...
                    <tr align="center">
                        ...
                        foreach ($kriterias as $kriteria):
                            ...
                            $id_kriteria = $kriteria['id_kriteria_v'];
                            echo '<td>';
                            // Tampilkan nama_v pada kolom C1 dan C2
                            if ($id_kriteria == '1' || $id_kriteria == '2') {
                                // Lakukan join dengan sub_kriteria_v untuk mendapatkan nama_v
                                $q4 = mysqli_query($koneksi, "SELECT sub_kriteria_v.nama_v FROM penilaian_v JOIN sub_kriteria_v WHERE penilaian_v.nilai_v = sub_kriteria_v.id_sub_kriteria_v AND penilaian_v.id_alternatif_v='$alternatif[id_alternatif_v]' AND penilaian_v.id_kriteria_v='$kriteria[id_kriteria_v]'");
                                $data = mysqli_fetch_array($q4);
                                echo $data['nama_v'];
                            } else {
                                // Tampilkan nilai SPF pada kolom C3
                                if ($id_kriteria == '3') {
                                    echo $alternatif['spf'];
                                } elseif ($id_kriteria == '4') {
                                    // Tampilkan nilai Harga pada kolom C4
                                    echo $alternatif['harga'];
                                } elseif ($id_kriteria == '5') {
                                    // Tampilkan nilai Berat pada kolom C5
                                    echo $alternatif['berat'];
                                } else {
                                    // Tampilkan nilai matriks pada kolom lain
        ...
        <div class="table-responsive">
            <table class="table table-bordered" width="100%" cellspacing="0">
                ...
                <tbody>
                    ...
                    <tr align="center">
                        <td><?= $no; ?></td>
                        <td align="center">A<?= $alternatif['id_alternatif_v'] ?></td>
                        <?php
                        foreach ($kriterias as $kriteria):
                            $id_alternatif = $alternatif['id_alternatif_v'];
                            $id_kriteria = $kriteria['id_kriteria_v'];
...
<div class="card shadow mb-4">
    <!-- /.card-header -->
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-info"><i class="fa fa-table"></i> Normalisasi Matriks (X)</h6>
    </div>
...
<div class="card shadow mb-4">
    <!-- /.card-header -->
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-info"><i class="fa fa-table"></i> Menentukan Nilai (R)</h6>
    </div>
...
<div class="card shadow mb-4">
    <!-- /.card-header -->
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-info"><i class="fa fa-table"></i> Hasil Nilai R</h6>
    </div>
...
<div class="card shadow mb-4">
    <!-- /.card-header -->
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-info"><i class="fa fa-table"></i> Hasil Nilai S</h6>
    </div>
        ...
        <div class="table-responsive">
            <table class="table table-bordered" width="100%" cellspacing="0">
                ...
                <tbody>
                    ...
                    <?php
						$no++;
						mysqli_query($koneksi,"SELECT * FROM hasil_v (id_hasil_v, id_alternatif_v, nilai_v) VALUES ('', '$alternatif[id_alternatif_v]', '$hasil')");
						endforeach
					?>
                    </tr>
                </tbody>
