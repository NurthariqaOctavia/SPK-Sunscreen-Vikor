...
<body class="bg-gradient-primary">
    <nav class="navbar navbar-expand-lg navbar-dark bg-white shadow-lg pb-3 pt-3 font-weight-bold">
        <div class="container">
            <a class="navbar-brand text-primary" style="font-weight: 900;" href="login.php"> <i
                    class="fa fa-database mr-2 rotate-n-15"></i> Sistem Pendukung Keputusan Metode VIKOR</a>
        </div>
    </nav>
                ...
                <div class="card bg-none o-hidden border-0 my-5 text-white" style="background: none;">
                    <div class="text-justify card-body p-0">
                        ...
                        <p class="pt-4">
                            ...
                            proses pengambilan keputusan dalam situasi yang semiterstruktur dan situasi yang tidak
                            terstruktur.
                        </p>
                        <p>
                            Metode Vise Kriterijumska Optimizacija I Kompromisno Resenje (VIKOR) didasarkan pada
                            perangkingan dan pemilihan dari sekumpulan alternatif yang ada. Metode ini dapat digunakan
                            untuk merangking sebanyak kriteria baik itu kualitatif maupun kuantitatif. Metode VIKOR
                            dapat menyelesaikan pengambilan keputusan bersifat diskret pada kriteria yang bertentangan
                            dan non commensurable, yaitu perbedaan unit antar kriteria.
                        </p>
                    </div>
                </div>
            </div>
